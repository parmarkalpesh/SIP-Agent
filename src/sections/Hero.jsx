    ...
    return (
        ...
        >
            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col lg:flex-row items-center gap-12 text-slate-900">
                    ...
                    <div className="lg:w-1/2 space-y-8 animate-fade-in-up">
                        ...
                        <p className="text-lg text-slate-600 leading-relaxed max-w-xl">
                            Start small, invest regularly, and build long-term wealth with a trusted SIP Agent.
                            Secure your future with the power of compounding.
                        </p>

                        <div className="flex flex-col sm:flex-row gap-4">
                            <a
                                href="#contact"
                                className="inline-flex justify-center items-center gap-2 px-8 py-4 bg-green-600 text-white font-semibold rounded-xl hover:bg-green-700 transition-all shadow-lg shadow-green-600/20 hover:shadow-green-600/40 transform hover:-translate-y-1"
                            >
                    ...
                    <div className="lg:w-1/2 relative animate-fade-in-right delay-200">
                        <div className="relative z-10 glass-card p-6 md:p-8 rounded-2xl border border-white/50">
                            <div className="flex justify-between items-start mb-6">
                                <div>
                                    <div className="text-slate-500 text-sm mb-1">Total Portfolio Value</div>
                                    <div className="text-3xl font-bold text-slate-900">₹ 25,48,900</div>
